...
def main(args):
    ...
    # Declare k-fold; kept as 1; simply utilized to have a train/val split
    fold_iter = None
    ...
    model = TimesformerForVideoClassification.from_pretrained(base_model_name, config=config, ignore_mismatched_sizes=ignore_mismatched_sizes)
    ...
    # for fold in range(n_splits):
        ...
        model_folder = (
            f"{args.model_name.lower()}-default-finetuned-{dataset_type}"
